...
- (void)buildUI {
    ...
    UIImageView *hour6 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"xl_clock_hour_6"]];
    hour6.frame = CGRectMake(0, 0, hourH, hourH);
    hour6.center = CGPointMake(self.bounds.size.width/2.0f, self.bounds.size.height - hourSpace);
    [self addSubview:hour6];
    
    UIImageView *hour9 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"xl_clock_hour_9"]];
    hour9.frame = CGRectMake(0, 0, hourH, hourH);
    hour9.center = CGPointMake(hourSpace, self.bounds.size.height/2.0f);
